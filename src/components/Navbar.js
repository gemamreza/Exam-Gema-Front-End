                                    ...
                                    <NavItem>
                                        {
                                            ...
                                            ?
                                            <Link to="/cart"><NavLink className="btn btn-default border-primary" style={{fontSize:"14px"}}><i class="fas fa-shopping-cart"></i>Carts<span class="badge badge-success"> {this.props.userCart} </span></NavLink></Link>
                                            : null
                                        }
                                    </NavItem>
                                    <UncontrolledDropdown nav inNavbar>
