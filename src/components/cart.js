   ...
   checkOut = () => {
    ...
    .then((res) => {
      ...
      for(var i=0; i < res.data.length; i++) {
        ...
        swal("Check Out Success", "Product Has Been Moved To History", "success")
        .then ((res)=>{
          console.log(res)
  ...
  render() {
    ...
    return (
            ...
            <Table className={classes.table}>
                ...
                <center>
                    <Button animated color ='teal' onClick={this.checkOut}>
                        ...
                        <TableCell colSpan={8}><h2><CurrencyFormat value={this.getTotalHarga()} displayType={'text'} thousandSeparator={true} prefix={'Total Harga : Rp. '}/></h2></TableCell>
                        </center>
                  </TableCell>
                </TableRow>
        ...
        : 
          ...
          <center>
          <strong>Your Cart is Currently Empty!</strong> Continue Shopping
          </center>
          </div>
        }
        </div> 
