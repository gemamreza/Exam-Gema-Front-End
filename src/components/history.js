...
class CustomPaginationActionsTable extends React.Component {
  ...
  getDataApi = () => {
      ...
      Axios.get(urlApi + '/history?id_user=')
      .then((res) => 
            ...
            <Table className={classes.table}>
                <TableHead>
                  <TableRow>
                    ...
                    <TableCell style={{fontSize:'15px', fontWeight:'600'}}>DATE</TableCell>
                    <TableCell style={{fontSize:'15px', fontWeight:'600'}}>ITEM</TableCell>
                    <TableCell style={{fontSize:'15px', fontWeight:'600'}}>PAYMENT TOTAL</TableCell>
            ...
            <Table className={classes.table}>
                <TableHead>
                  ...
                  <TableCell style={{fontSize:'15px', fontWeight:'600'}}>NO</TableCell>
                    <TableCell style={{fontSize:'15px', fontWeight:'600'}}>Product Name</TableCell>
                    <TableCell style={{fontSize:'15px', fontWeight:'600'}}>QTY</TableCell>
                    <TableCell style={{fontSize:'15px', fontWeight:'600'}}>DISCOUNT</TableCell>
                    <TableCell style={{fontSize:'15px', fontWeight:'600'}}>Price/Pcs</TableCell>
                  </TableRow> 
                </TableHead>
                <TableBody>
